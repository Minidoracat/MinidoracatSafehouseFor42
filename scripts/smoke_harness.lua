...
local MEDIA = "MOD/MinidoracatSafehouseFor42/Contents/mods/MinidoracatSafehouseFor42/42/media/lua"
...
-- 目前沒有遊戲功能模組；開始實作後再依 shared → server/client 順序載入受測檔案。
...
-- ===== 情境 =====
-- 開始實作功能後，依下列形狀加入可觀察行為情境（參考 Cleaner 的 scripts/smoke_scanner.lua）：
